...
aspect_ratios = [[[0.72, 0.96], [0.68, 1.17]], [[1.30, 0.66], [0.63, 1.23], [0.87, 1.41]],
                 [[1.96, 1.23], [0.58, 0.84], [0.61, 1.15]], [[19.79, 2.21], [0.47, 1.76], [1.38, 0.79]],
                 [[4.79, 17.96], [1.04]], [[14.82]]]
...
def optimize(full_bboxes, optim_idx, batch_size=5000):
    ...
    res = minimize(step, x0=scales[optim_idx] if optimize_scales else sum(aspect_ratios[optim_idx], []),
                   method='Powell',
