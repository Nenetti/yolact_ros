...
#include <semantic_segmentation/modules/geometric_edge_map.h>
...
namespace semantic_segmentation {
     ...
     * @param mask_map
     */
    void GeometricEdgeMap::to_mask(std::vector<Segment> &segments, std::vector<int8_t> &mask_map) {
        int i = 0;
        int index, x, y;
